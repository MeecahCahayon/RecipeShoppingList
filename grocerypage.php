...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="scss/grocerystyle.css">
		...
		<script type="text/javascript" src="js/groceryscript.js"></script>
	</head>

	<body onload="prep_grocery_page()">
		<div class="outerDiv" id="pageOuterDiv">
			...
			<section class="outerGrids" id="mainGrid">
				...
				<!-- GROCERY HEADING -->
				<section class="innerGrids" id="groceryHeadingGrid">
					<div id="groceryHeadingContent">
						<div class="secondHeading">
							<p> Grocery List </p>
						</div>
						<div class="subtitle">
							<p> Your Grocery Lists. You can add more grocery. </p>
						</div>
					</div>
				</section>

				<!-- GROCERY SELECT -->
				<!-- <section class="innerGrids" id="grocerySearchGrid">
					<div id="groceryselect">
						<select class="userinputs" id="grocerySearchField">
							<option></option>
						</select>
					</div>
				</section> -->
				...
				<!-- GROCERY LIST -->
				<section class="innerGrids" id="groceryListGrid">
					<div id="grocerylist">
					</div>
				</section>
			</section>
